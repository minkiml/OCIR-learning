...
# sh ./scripts/rul/ocir_learning_disc_rul_FD004.sh
...
do
    ...
    --n_epochs 100 --rul_epochs 100 --batch $batch_size --lr_ 0.00025 --rul_lr 0.0006 \
    --scheduler 0 --warm_up 0.2 --final_lr 0.0001 --ref_lr 0.0002 --start_lr 0.00005 --start_wd 0.001 --final_wd 0.001
done
# --scheduler 0 --warm_up 0.2 --final_lr 0.00005 --ref_lr 0.00015 --start_lr 0.0001 --start_wd 0.001 --final_wd 0.0001