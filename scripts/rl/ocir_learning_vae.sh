...
# sh ./scripts/rl/ocir_learning_vae.sh
...
do
    ...
    --description vae_nf_kl_fd004_klmulogvar \
    --id_ $run_id \
    --dataset $data \
    --net vae \
    --task RL \
    ...
    --window $W \
    --time_embedding True \
    --dx 14 --dz 32 --dc 6 --d_model 128 --num_heads 4 \
    --z_projection aggregation_all \
    --D_projection aggregation \
    --c_posterior_param soft \
    --n_epochs 60 --batch $batch_size --lr_ 0.00025 \
